      ...
      <div className="mb-8">
        ...
        <div className="mt-4 bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-800 rounded-lg p-4">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-indigo-800 dark:text-indigo-200">About SandSwitch Bartering</h3>
              <div className="mt-2 text-sm text-indigo-700 dark:text-indigo-300">
                <p>This is a <strong>bartering platform</strong> for skill and service exchanges at John Abbott College. No money is exchanged - only your time and skills. Exchanges can happen on campus or online.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                <p>To maintain a quality platform, users can create up to <strong>5 exchanges per day</strong> and no more than <strong>2 per 5-minute period</strong>.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 shadow-lg rounded-xl overflow-hidden">
        ...
        <div>
            ...
            <button
              ...
              onClick={() => handleInputChange({ target: { name: "type", value: "request" } })}
                  className={`relative px-6 py-4 border-2 rounded-xl text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500 transition-all duration-300 ease-in-out ${
                formState.type === "request"
                      ? "bg-pink-600 text-white border-transparent transform scale-105"
                  : "bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700"
              }`}
            >
                  <div className="flex flex-col items-center">
        ...
        <div>
          <label htmlFor="title" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                Give your exchange a clear title
          </label>
          ...
          <input
            ...
            onChange={handleInputChange}
                  className={`block w-full px-4 py-3 rounded-md focus:outline-none sm:text-sm border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:text-white transition-all duration-200 ${formErrors.title ? 'border-red-500 text-red-900 dark:text-red-400 focus:border-red-500 focus:ring-red-500' : ''}`}
                  placeholder={formState.type === "offering" ? 
                    "e.g., 'Math Tutoring' or 'Guitar Lessons'" :
                    "e.g., 'Need Help with Essay' or 'Looking for Spanish Practice'"}
                  maxLength={70}
                />
                {formErrors.title ? (
              ...
              <div className="mt-2 flex justify-between">
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  A good title is specific and gets attention.
                </p>
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  {formState.title.length} / 70 characters
                </p>
              </div>
        ...
        <div>
          <label htmlFor="description" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                Describe your service exchange in detail
          </label>
          ...
          <textarea
            ...
            onChange={handleInputChange}
                  className={`block w-full px-4 py-3 rounded-md focus:outline-none sm:text-sm border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:text-white transition-all duration-200 ${formErrors.description ? 'border-red-500 text-red-900 dark:text-red-400 focus:border-red-500 focus:ring-red-500' : ''}`}
                  placeholder={formState.type === "offering" ? 
                    "Describe what you're offering, your experience level, availability, and what you might want in exchange..." :
                    "Describe what you're looking for, your requirements, timeline, and what you can offer in return..."}
                  maxLength={1000}
                />
              </div>
              <div className="mt-2 flex justify-between">
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  Be specific about what's included. Minimum 20 characters.
                </p>
                <p className="text-xs text-gray-500 dark:text-gray-400">
              ...
              <div className="mt-3 p-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg">
                <h3 className="text-sm font-medium text-indigo-800 dark:text-indigo-200 mb-2">Tip: What makes a good barter description?</h3>
                <ul className="list-disc pl-5 text-xs text-indigo-700 dark:text-indigo-300 space-y-1">
                  <li>Explain your experience or requirements clearly</li>
                  <li>Mention any specific skills or equipment needed</li>
                  <li>Include time frames and time commitment expected</li>
                  <li>Suggest what you might want in exchange (no monetary value)</li>
                  <li>Indicate preferred meeting times on campus</li>
                </ul>
              </div>
        </div>
        ...
        <div>
          <label htmlFor="category" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                  What category best fits your exchange?
          </label>
                <div className="mt-1 relative rounded-md shadow-sm">
          <select
            id="category"
            ...
            onChange={handleInputChange}
                    className={`block w-full px-4 py-3 rounded-md focus:outline-none sm:text-sm border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:text-white appearance-none pr-10 ${formErrors.category ? 'border-red-500 text-red-900 dark:text-red-400 focus:border-red-500 focus:ring-red-500' : ''}`}
          >
            ...
            {categories.map((category) => (
              ...
              {/* Location - Changed to a select with campus locations */}
        <div>
          <label htmlFor="location" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                  Where will this exchange take place?
          </label>
                <div className="mt-1 relative rounded-md shadow-sm">
            ...
            onChange={handleInputChange}
                    className={`block w-full pl-10 pr-4 py-3 rounded-md focus:outline-none sm:text-sm border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:text-white appearance-none ${formErrors.location ? 'border-red-500 text-red-900 dark:text-red-400 focus:border-red-500 focus:ring-red-500' : ''}`}
                  >
                ...
                <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  Exchanges can take place on John Abbott Campus or online.
                </p>
              </div>
        </div>
        ...
        <div>
              <label htmlFor="tagInput" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                Add tags to help people find your exchange
          </label>
            ...
            <input
              ...
              onKeyDown={(e) => {
                if (e.key === 'Enter' && e.target.value.trim()) {
                  ...
                  placeholder="e.g., tutoring, language, music, programming"
                />
                <button
                  type="button"
            ...
            {formState.tags.map((tag) => (
              ...
              <div className="mt-3 p-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg">
                <h3 className="text-sm font-medium text-indigo-800 dark:text-indigo-200 mb-2">Tag suggestions for campus exchanges:</h3>
                <div className="flex flex-wrap gap-2 mt-2">
                  ...
                  <button type="button" onClick={() => {
                    if (!formState.tags.includes('study') && formState.tags.length < 5) {
                      setFormState(prev => ({...prev, tags: [...prev.tags, 'study']}))
                    }
                  }} className="text-xs bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 px-2 py-1 rounded-full text-gray-700 dark:text-gray-300">
                    study
                  </button>
                  <button type="button" onClick={() => {
                    if (!formState.tags.includes('notes') && formState.tags.length < 5) {
                      setFormState(prev => ({...prev, tags: [...prev.tags, 'notes']}))
                    }
                  }} className="text-xs bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 px-2 py-1 rounded-full text-gray-700 dark:text-gray-300">
                    notes
                  </button>
